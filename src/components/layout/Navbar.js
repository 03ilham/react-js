...
const Navigation = styled.section`
    ...
    nav .btn:hover {
        ...
        box-shadow: inset 0 0 5px #13ble7;
        color: #fff;
    }
...
export default function Navbar() {
    return (
        <Navigation>
            <img src="../../codeid.png" alt="codeid" className="logo"/>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="/signin" className="btn">Sigin</a></li>
                </ul>
            </nav>
        </Navigation>
    )
